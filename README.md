...
~~계속 수정중인 프로젝트 입니다. 오류가 발생하는 경우 수정중입니다!~~ <br>
프로젝트 개발을 임시 보류합니다. 저에게 필요한 프로젝트중 하나가 될 것이기 때문에, <br>
좀더 실력을 키우고 이 프로젝트를 다시 시작하려 합니다.
...
<BlockQuote>업데이트 내용 참조</BlockQuote>
https://kindermoumi-browser.vercel.app/notice/update
